...
static constexpr auto qt_meta_stringdata_ZN7myclassE = QtMocHelpers::stringData(
    "myclass",
    "myFunction",
    ""
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN7myclassE[] = {
...
Q_CONSTINIT const QMetaObject myclass::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN7myclassE.offsetsAndSizes,
    qt_meta_data_ZN7myclassE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN7myclassE_t,
        // Q_OBJECT / Q_GADGET
...
void *myclass::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN7myclassE.stringdata0))
